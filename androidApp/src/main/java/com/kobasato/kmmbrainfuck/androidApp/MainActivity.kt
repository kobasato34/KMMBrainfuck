...
class MainActivity : AppCompatActivity(), DIAware {
    ...
    private val programEditorViewModel by viewModels<ProgramEditorViewModel>(factoryProducer = {
    ...
    private val programListViewModel by viewModels<ProgramListViewModel>(factoryProducer = {
        object : ViewModelProvider.Factory {
            override fun <T : ViewModel?> create(modelClass: Class<T>): T {
                return when (modelClass) {
